...
export function BlogPostDetailPage({ slug }: { slug: string }) {
  ...
  const title = post.title[typedLocale];
  const excerpt = post.excerpt[typedLocale];
  const category = post.category[typedLocale];
  const takeaways = post.keyTakeaways[typedLocale];
        ...
        <div className="container-shell relative py-20 lg:py-24">
          <div className="max-w-4xl">
            ...
            >
              ...
              {typedLocale === "fr" ? "Retour au blog" : "Back to blog"}
            </Link>
            ...
            <div className="font-ui mb-5 inline-flex w-fit items-center gap-2 rounded-full border border-indigo-400/20 bg-indigo-500/10 px-4 py-2 text-sm text-indigo-200">
              ...
              {typedLocale === "fr" ? "Article" : "Article"}
            </div>
